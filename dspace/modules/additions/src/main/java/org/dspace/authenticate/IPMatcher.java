...
public class IPMatcher
{
    ...
    /**
    <JR> - 3. 3. 2021 - Adding private variable ipSpec that will hold information about configured allowed IP addreses from IPAuthentication config
     */
    private String ipSpec;

    /**
    <JR> - 3. 3: 2021 - Adding a getter and setter for ipSpec variable, 
    to be able to initialize it and get information stored in it from outside of this class
     */
    ...
    public IPMatcher(String ipSpec) throws IPMatcherException
    {
        ...
        // <JR> - 3. 3. 2021 - store IP address parts from config
        setIPSpec(ipSpec);
    ...
    {
        // JR - 4. 2. 2020: match() is called fro each IPMatcher object
