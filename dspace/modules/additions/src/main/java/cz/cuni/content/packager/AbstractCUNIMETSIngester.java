 ...
 * @see PackageIngester
 */
public abstract class AbstractCUNIMETSIngester extends AbstractPackageIngester
{
    /** log4j category */
    private static Logger log = Logger.getLogger(AbstractCUNIMETSIngester.class);
    ...
    public DSpaceObject ingest(Context context, DSpaceObject parent,
        ...
        try
        {
            log.info(LogManager.getHeader(context, "package_parse",
                    "CUNI: Parsing package for ingest, file=" + pkgFile.getName()));
            ...
            if (manifest == null)
            {
                throw new PackageValidationException(
                        "CUNI: No METS Manifest found (filename="
    ...
    protected DSpaceObject ingestObject(Context context, DSpaceObject parent,
            ...
            catch(UnsupportedOperationException e)
            {
                ...
                if(params.getBooleanProperty("skipIfParentMissing", false))
                {
                    ...
                    log.warn(LogManager.getHeader(context, "package_ingest",
                            "CUNI: SKIPPING ingest of object '" + manifest.getObjID()
        ...
        {
            throw new PackageValidationException(
                    "CUNI: Unable to initialize object specified by package (type='"
        ...
        {
            throw new PackageValidationException(
                    "CUNI: Unknown DSpace Object type in package, type="
                            + String.valueOf(type));
        }
            ...
            MetadataValidationException, PackageValidationException
    {
        ...
        {
            throw new PackageValidationException(
                    "CUNI: The object type of the METS manifest ("
        ...
        {
            log.debug("CUNI: Object to be replaced (handle=" + dso.getHandle()
            ...
            CrosswalkException, PackageValidationException
    {
        ...
        if (primaryFile != null)
        {
            ...
            if (log.isDebugEnabled())
            {
                log.debug("CUNI: Got primary bitstream file ID=\"" + primaryID + "\"");
            }
        }
                ...
                .hasNext();)
        {
            ...
            {
                throw new PackageValidationException(
                        "CUNI: Invalid METS Manifest: file element without ID attribute.");
            }
        ...
        {
            log.warn("CUNI: Could not find primary bitstream file ID=\"" + primaryID
            ...
            AuthorizeException, PackageValidationException
    {
        ...
        {
            throw new PackageValidationException(
                    "CUNI: Configuration Error: No Manifest BitstreamFormat configured for METS ingester type="
    ...
    public DSpaceObject replace(Context context, DSpaceObject dsoToReplace,
        ...
        {
            log.info(LogManager.getHeader(context, "package_parse",
                    "CUNI: Parsing package for replace, file=" + pkgFile.getName()));
            ...
            throws AuthorizeException, SQLException, IOException
    {
        if (log.isDebugEnabled())
        {
            log.debug("CUNI: Removing object " + Constants.typeText[dso.getType()]
                    + " id=" + dso.getID());
        }
            ...
            SQLException
    {
        ...
        if (parentLink != null && parentLink.length() > 0)
        {
            ...
            if (parent == null)
            {
                throw new UnsupportedOperationException(
                        "CUNI: Could not find a parent DSpaceObject referenced as '"
                                + parentLink
        ...
        {
            throw new UnsupportedOperationException(
                    "CUNI: Could not find a parent DSpaceObject where we can ingest the packaged object "
                    + manifest.getObjID()
                    + ".  A parent DSpaceObject must be specified from either the 'packager' command or noted in the METS Manifest itself.");
        }
            ...
            throws MetadataValidationException, IOException
    {
        ...
        if (params.getBooleanProperty("manifestOnly", false))
        {
            ...
            {
                log
                        .error("CUNI: Unable to retrieve external file from URL '"
                                + path
        ...
        else
        {
            ...
            {
                throw new MetadataValidationException("CUNI: Manifest file references file '"
