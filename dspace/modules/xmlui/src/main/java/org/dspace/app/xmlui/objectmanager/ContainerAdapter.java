    ...
    protected void renderDescriptiveSection() throws WingException, SAXException, CrosswalkException, IOException, SQLException 
    {
        ...
        if(dmdTypes.isEmpty() || dmdTypes.contains("DIM"))
        {
            ...
            if (dso.getType() == Constants.COLLECTION) 
            {
                ...
                String translatedcollectiontitle = collectionService.getMetadataFirstValue(collection, "dc", "translatedcollectiontitle", null,
                                                                                          Item.ANY);
                ...
                createField("dc","translatedcollectiontitle",null,null,translatedcollectiontitle);
