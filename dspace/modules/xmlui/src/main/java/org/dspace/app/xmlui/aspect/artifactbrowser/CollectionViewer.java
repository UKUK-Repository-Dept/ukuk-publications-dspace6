...
public class CollectionViewer extends AbstractDSpaceTransformer implements CacheableProcessingComponent
{
    ...
    DSpaceServicesFactory.getInstance().getServiceManager().getServiceByName("translateService", 
            ...
            AuthorizeException
    {
        ...
        // Set the page title
        String name = translateService.retrieveTranslationByContextLocale(context, collection);
