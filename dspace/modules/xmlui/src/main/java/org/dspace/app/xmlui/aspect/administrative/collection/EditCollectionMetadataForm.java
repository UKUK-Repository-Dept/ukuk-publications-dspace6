...
public class EditCollectionMetadataForm extends AbstractDSpaceTransformer   
{
	...
	private static final Message T_label_translatedcollectiontitle = message("xmlui.administrative.collection.EditCollectionMetadataForm.label_translatedcollectiontitle");
            ...
            throws WingException, SQLException, AuthorizeException
    {
	    ...
	    name.setValue(collectionService.getMetadata(thisCollection, "name"));
		 ...
		 // translated name
	    metadataList.addLabel(T_label_translatedcollectiontitle);
	    Text translatedTitle = metadataList.addItem().addText("translatedcollectiontitle");
		translatedTitle.setSize(40);
		translatedTitle.setValue(collectionService.getMetadataFirstValue(thisCollection, "dc", "translatedcollectiontitle", null,"*"));
