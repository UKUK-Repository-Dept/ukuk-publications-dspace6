...
public class HandleUtil
{
    ...
    protected static final  TranslateService translateService = DSpaceServicesFactory.getInstance().getServiceManager().getServiceByName("translateService", TranslateService.class);
            ...
            String contextPath, boolean linkOriginalObject) throws SQLException, WingException
    {
        ...
        while (!stack.empty())
        {
            ...
            if (pop instanceof Collection)
            {
            	...
            	String name = getCollectionNameByLocale(context, collection);
    ...
    private static String getCollectionNameByLocale(Context context, Collection collection) {
        return translateService.retrieveTranslationByContextLocale(context, collection);
    }
