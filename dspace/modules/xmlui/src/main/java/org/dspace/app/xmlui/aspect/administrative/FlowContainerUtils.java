...
public class FlowContainerUtils 
{
	...
	public static FlowResult processEditCollection(Context context, UUID collectionID, boolean deleteLogo, Request request) throws SQLException, IOException, AuthorizeException
	{
		...
		String translatedcollectiontitle = request.getParameter("translatedcollectiontitle");
		...
		if (translatedcollectiontitle != null && translatedcollectiontitle.length() == 0)
		{
		...
		collectionService.clearMetadata(context, collection, "dc", "translatedcollectiontitle", null, Item.ANY);
		collectionService.addMetadata(context, collection, "dc", "translatedcollectiontitle", null, null, translatedcollectiontitle);
            ...
            throws SQLException, AuthorizeException, IOException
	{
		...
		collectionService.addMetadata(context, newCollection, "dc", "translatedcollectiontitle", null, null, translatedcollectiontitle);
